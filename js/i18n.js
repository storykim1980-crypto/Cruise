...
const I18N = (() => {
  ...
  const dict = {
    ja: {
      ...
      videosDesc: "東京湾で記録されたクルーズ客船の映像コレクション。サムネイルを選ぶとページ内で再生されます(YouTube連携)。",
      watchOnYouTube: "YouTubeで見る",
      closeLabel: "閉じる",
      nextCallChip: "次の入港まで {d} 日",
      menu: "メニュー",
      footerBrowse: "閲覧",
      footerPort: "東京港",
      footerRefs: "リンク",
    ...
    en: {
      ...
      videosDesc: "A video collection of cruise ships recorded in Tokyo Bay. Pick a thumbnail to play it right here (via YouTube).",
      watchOnYouTube: "Watch on YouTube",
      closeLabel: "Close",
      nextCallChip: "Next port call in {d} days",
      menu: "Menu",
      footerBrowse: "Browse",
      ...
      noUpcoming: "No upcoming calls scheduled",
      ...
      bridgeLimit: "Bridge clearance limit",
      megaCapable: "Mega-ship capable",
