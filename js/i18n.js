...
const I18N = (() => {
  ...
  const dict = {
    ja: {
      ...
      topbarLeft: "船舶写真 · 船舶情報 · 東京湾アーカイブ — 参考:",
      topbarRightAbout: "概要 / データ追加",
      heroEyebrow: "東京湾 · クルーズ客船フォトアーカイブ",
      footerTerms: { intl: "東京国際CT", harumi: "晴海", takeshiba: "竹芝" },
      topbarRightPhotos: "写真を見る",
      ...
      footerTagline:
        "東京に寄港するクルーズ客船のフォトアーカイブ。1枚の写真に IMO・撮影地・カテゴリを紐づけ、ShipSpotting のように残せます。",
      footerCopy: "© 2026 東京クルーズログ · 趣味のアーカイブ",
      footerInspired: "レイアウト着想: ShipSpotting.com",
      loading: "読み込み中…",
      ...
      shipCount: (n) => `${n} 隻`,
      callCount: (n) => `${n} 件`,
      shipsPageTitle: "船舶データベース",
      shipsPageDesc: "東京湾で記録したクルーズ客船。各船ページから IMO 紐づけの写真一覧へ。",
    ...
    en: {
      ...
      brandEn: "東京クルーズログ",
      topbarLeft: "Ship photos · Vessel info · Tokyo Bay archive — inspired by",
      topbarRightAbout: "About / Add data",
      heroEyebrow: "Tokyo Bay · Shipspotting Archive",
      footerTerms: { intl: "Tokyo Intl CT", harumi: "Harumi", takeshiba: "Takeshiba" },
      topbarRightPhotos: "Browse photos",
      ...
      footerTagline:
        "A photo archive of cruise ships calling at Tokyo. Each image is tagged with IMO, location and category — in the spirit of ShipSpotting.com.",
      footerCopy: "© 2026 Tokyo Cruise Log · Hobby archive",
      footerInspired: "Layout inspired by ShipSpotting.com",
      loading: "Loading…",
      ...
      shipsPageTitle: "Ship database",
      shipsPageDesc: "Cruise ships documented in Tokyo Bay. Open a vessel for IMO-linked photos.",
